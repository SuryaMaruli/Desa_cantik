...
class ProfilKelurahanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ProfilKelurahan::create([
            'nama_kelurahan' => 'Citangkil',
            'tahun_pembukaan' => '1985',
            'nomor_kode_wilayah' => '36.71.02.1009',
            'nomor_kode_pos' => '42441',
            'kecamatan' => 'Citangkil',
            'kabupaten_kota' => 'Cilegon',
            'dasar_hukum_pembentukan' => 'Peraturan Pemerintah Nomor 45 Tahun 1985 tentang Pembentukan Kelurahan Citangkil',
            'provinsi' => 'Banten',
